...
## [1.6.0] - 2026-05-08
### 🔄 Modificado
- **CSS Massivo:** Limpeza profunda de estilos legados, ajustes finos na paleta de cores do Dark Mode e desacoplamento de lógicas que estavam misturadas com JavaScript.
- **Refatoração:** Ajustes de semântica e organização nos arquivos HTML e scripts JS.

## [1.5.1] - 2026-05-04
### 🔄 Modificado
- **Métodos de Pagamento:** Ajustes nas regras de processamento financeiro.
